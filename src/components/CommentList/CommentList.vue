          ...
          <div class="top">
            ...
            <div class="fatherinput" v-show="currentShow == item.id">
              ...
              <img
                src="./1.png"
                alt=""
                @click="submit(item.id, item.username)"
              />
                ...
                <div class="li-item">
                  ...
                  <div class="top">
                    <div class="lw" @click="currentShow = code.id">
                      <span><i class="el-icon-chat-dot-round"></i></span>
                      <span v-show="code.username === userinfo.username"
                        ><i
                          class="el-icon-delete"
                    ...
                    <div class="fatherinput" v-show="currentShow == code.id">
                      ...
                      <img
                        src="./1.png"
                        alt=""
                        @click="submit2(item.id, code.username)"
                      />
                      <span
                        class="el-icon-close"
                        @click="currentShow = -2"
...
export default {
  ...
  methods: {
    ...
    //   this.$api.getComment({ page, articleid }).then((res) => {
    //     if (res.data.status === 200) {
    //       //   this.loading = false;
